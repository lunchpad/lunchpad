...
#   should allow_value("EXAMPLE@example.COM").for(:email)
#   should allow_value("A_US-ER@exam.ple.org").for(:email)
#   should allow_value("first.last@example.me").for(:email)
#   should allow_value("me+you@example.co.uk").for(:email)
#
#   should_not allow_value("user_at_example.com").for(:email)
#   should_not allow_value("user.name@example.").for(:email)
#   should_not allow_value("foo@bar_baz.com").for(:email)
#   should_not allow_value("foo@bar+baz.com").for(:email)
